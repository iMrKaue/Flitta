...
func main() {
	...
	http.HandleFunc("/admin/professionals/create", middleware.AuthMiddleware(handler.CreateProfessionalHandler))
	...
	http.HandleFunc("/admin/intelligence/hours", middleware.AuthMiddleware(handler.GetHourPerformanceHandler))
